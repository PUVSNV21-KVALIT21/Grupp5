...
namespace hakimlivs.Migrations
{
    ...
    [Migration("20220519075235_CorrectImage")]
    partial class CorrectImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hakimlivs.Models.Image", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("hakimlivs.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("hakimlivs.Models.CartItem", b =>
                {
                    b.HasOne("hakimlivs.Models.Cart", "Cart")
                        .WithMany("CartItem")
            ...
            modelBuilder.Entity("hakimlivs.Models.Product", b =>
                {
                    ...
                    b.HasOne("hakimlivs.Models.Image", "Image")
                        .WithMany()
